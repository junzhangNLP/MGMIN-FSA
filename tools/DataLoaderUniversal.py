...
def get_data_loader(opt):
    ...
    batch_size, num_workers, pin_memory =opt.batch_size, opt.num_workers, opt.pin_memory
    ...
    if 'mosi' in dataset:
        ...
        data_loader_train = DataLoader(dataset_train, batch_size, collate_fn=multi_collate_mosei_mosi, shuffle=True, 
            persistent_workers=persistent_workers, num_workers=num_workers, pin_memory=pin_memory, drop_last=True)
